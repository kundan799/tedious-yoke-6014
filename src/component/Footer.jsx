...
export default function Footer() {
  return (
    <Box
      bg={useColorModeValue("#003953", "#003953")}
      color={useColorModeValue("white", "white")}
    >
      <Box maxH="sm" bg="#032c48" height="150px" padding={"20px"}>
        <h1 style={{fontWeight:"600",fontSize:"20px"}}>Make Zappos (Emails) Your New BFF!</h1>
        <br/>
        <h3>Email</h3>
        <div style={{display:"flex",gap:"20px"}}>
        <Input placeholder='Email Address' width="200px" bg="white"/>
        <Button
              _hover={{ backgroundColor: "white", color: "#032c48" }}
              colorScheme="white"
              variant="outline"
            >
              {" "}
             <HiOutlineMailOpen/>{" "} SUSCRIBE TO ZAPPOS EMAILS{" "}
            </Button>
      ...
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
          <Stack align={"flex-start"}>
            <ListHeader>Explore Zappos</ListHeader>
            ...
            <Link href={"#"}>Education & Military Program</Link>
          ...
          <Stack align={"flex-start"}>
            <ListHeader>About Zappos</ListHeader>
            ...
            <Link href={"#"}>Powered by Zappos</Link>
            <Link href={"#"}>Coupons</Link>
            <Link href={"#"}>Accessibility Statement</Link>
            <Link href={"#"}>Accessibility Survey</Link>
            <Link href={"#"}>Beyond the Box Blog</Link>
            <br />
            ...
            <Link href={"#"}>Glossary of Terms</Link>
            <Link href={"#"}>Site Map</Link>
          </Stack>
          <div>
          <div
            style={{
              border: "1px solid #144860",
              height: "250px",
              width: "350px",
              padding: "20px",
              backgroundColor: "#144860",
            }}
          >
            ...
            <br />
            <Button
              _hover={{ backgroundColor: "white", color: "#144860" }}
              colorScheme="white"
              variant="outline"
            >
              {" "}
             <TiMessages/> TAKE SURVEY{" "}
            </Button>
          </div>
          <br/>
          <h1 style={{fontSize:"25px"}}>Connect With Us</h1>
          <br/>
          <div style={{display:"flex",gap:"10px"}}>
            <AiOutlineFacebook style={{fontSize:"35px"}}/>
      ...
      <Box py={10}>
        ...
        ></Flex>
        <Text pt={8} fontSize={"sm"} textAlign={"left"} paddingLeft="20px">
        Terms of Use |{" "}Privacy Policy |  Fur Policy | Interest-Based Ads | 24/7 Customer Service (800) 927-7671
        </Text>
        <Text pt={8} fontSize={"sm"} textAlign={"left"}  paddingLeft="20px" >
        © 2009–2022 - Zappos.com LLC or its affiliates
        </Text>
      </Box>
    </Box>
  );
